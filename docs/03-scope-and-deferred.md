...
| Basic personal Verlanglijst: view, add and remove | V2.001 primary scope | V2.001 MUST | V1 contains wishlist data and the daily list must remain usable | Core/schema/MIG-FND target is implemented in WISH-CORE-01 and owner-only REST in WISH-API-01; WISH-UI-01 remains required for reachability, without merging entries into Collections, Gewenste aanwinsten or Hierna lezen |
