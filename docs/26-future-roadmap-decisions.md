...
| C-15 | V1-leningen / cutover | Als MIG-01 actieve/open V1-leningen aantreft, moet Renée afzonderlijk beslissen welk minimaal V2.001 settlement-/afsluitcontract nodig is. De volledige lending-feature blijft V2.002+. | [`03-scope-and-deferred.md` §3 en §9](03-scope-and-deferred.md#3-v2001-release-reclassification-matrix) |
...
| Leesdoelen | Actieve feature **V2.002+**; bestaande V1-goaldata **PRESERVE DATA ONLY**, waarbij MIG-01 `MAPPED`, `PRESERVED_DEFERRED` of `QUARANTINED` bepaalt. | [`01-functional-design.md` §13](01-functional-design.md#13-reading-goals); [`06-testing-and-acceptance.md` §15](06-testing-and-acceptance.md#15-reading-goalsstatistics); Series-/Collection-goalbesluiten A-05 en A-10 en open naamgeving C-10 | ReadingRound-bronwaarheid waarop latere progressie rust: [`ADR-007`](decisions/ADR-007-f2-6-reading-round-lifecycle-and-historical-truth.md). Geen actieve Goals-feature aangetoond. |
| Lending | Volledige module **V2.002+**. MIG-01 inventariseert circulatie; alleen aantoonbaar noodzakelijke cutover-support is **V2.001 MINIMUM IF MIGRATION REQUIRES**. Behandeling van actieve/open V1-leningen blijft C-15. | [`01-functional-design.md` §8](01-functional-design.md#8-borrowed-and-lent); [`06-testing-and-acceptance.md` §8](06-testing-and-acceptance.md#8-internal-lending) | Bronmodelbesluit: [`ADR-004`](decisions/ADR-004-fase-0-persistence-and-reading-sources.md#internalloan). Archive-evidence benoemt de nog afwezige InternalLoan-target expliciet: [`37-library-item-archive-lifecycle-foundation-exit-evidence.md`](37-library-item-archive-lifecycle-foundation-exit-evidence.md). |
| Ratings/Reviews write/publication | Nieuwe write-/publication-/moderation-UI **V2.002+**; bestaande V1-bijdragen zijn **MAPPED** naar het V2.001-doel en moeten behouden en leesbaar blijven. | [`01-functional-design.md` §12](01-functional-design.md#12-ratings-reviews-and-notes); contractanalyse [`12-f2-8a-ratings-reviews-analysis.md`](12-f2-8a-ratings-reviews-analysis.md) | Core-lifecycle is gebouwd: [`13-f2-8b-exit-evidence.md`](13-f2-8b-exit-evidence.md). Public-readfoundation: [`30-b7-ratings-reviews-public-read-evidence.md`](30-b7-ratings-reviews-public-read-evidence.md). Book Detail is read-only: [`58-book-api-03-book-detail-ratings-reviews-projection.md`](58-book-api-03-book-detail-ratings-reviews-projection.md). |
...
| Biblio-owned covers | Onafhankelijke acquisitie/management **V2.002+**; V1-coverreferenties/assets **PRESERVE DATA ONLY** en door MIG-01 te inventariseren. V2.001 mag truthful no-cover tonen. | [`01-functional-design.md` §4](01-functional-design.md#covers); presentatiecontract [`31-biblio-design-system.md` §11.1](31-biblio-design-system.md#111-bookcoverpresentation) | De huidige Book Detail-evidence bewijst alleen truthful no-cover, geen owned-coverbeheer: [`55-ui-book-01-book-detail-visual-baseline.md`](55-ui-book-01-book-detail-visual-baseline.md). |
...
| Wishlist-groepering | Groepering, smart groups en Series-completenesslogica **V2.002+**; basis-Verlanglijst blijft V2.001-MUST. Bronrelaties worden, indien aanwezig, door MIG-01 behouden zonder completeness te verzinnen. | Basis en afbakening: [`01-functional-design.md` §7](01-functional-design.md#verlanglijst); releasegrens: [`03-scope-and-deferred.md`](03-scope-and-deferred.md#3-v2001-release-reclassification-matrix) | Geen afzonderlijke grouping-foundation of actieve grouping-feature aangetoond. |
