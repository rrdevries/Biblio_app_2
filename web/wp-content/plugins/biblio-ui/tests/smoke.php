...
echo "Script Module: biblio-ui/app@0.16.1" . PHP_EOL;
echo "API Script Module: biblio-ui/api@0.16.1" . PHP_EOL;
echo "Catalog Query Script Module: biblio-ui/catalog-query@0.16.1" . PHP_EOL;
echo "Route Script Module: biblio-ui/route-state@0.16.1" . PHP_EOL;
echo "Library Script Module: biblio-ui/library-state@0.16.1" . PHP_EOL;
echo "Overview Script Module: biblio-ui/overview-view@0.16.1" . PHP_EOL;
echo "UI Preferences Script Module: biblio-ui/ui-preferences@0.16.1" . PHP_EOL;
echo "UI Shell Script Module: biblio-ui/ui-shell@0.16.1" . PHP_EOL;
echo "Private Notes Script Module: biblio-ui/private-notes@0.16.1" . PHP_EOL;
echo "Reading History Script Module: biblio-ui/reading-history@0.16.1" . PHP_EOL;
echo "Detail Script Module: biblio-ui/detail-view@0.16.1" . PHP_EOL;
echo "Start Reading Script Module: biblio-ui/start-reading-view@0.16.1" . PHP_EOL;
echo "End Reading Script Module: biblio-ui/end-reading-view@0.16.1" . PHP_EOL;
echo "Add Book Script Module: biblio-ui/add-book-wizard@0.16.1" . PHP_EOL;
echo "Next Reading Script Module: biblio-ui/next-reading@0.16.1" . PHP_EOL;
echo "Wishlist Script Module: biblio-ui/wishlist@0.16.1" . PHP_EOL;
echo "Search Script Module: biblio-ui/bibliographic-search@0.16.1" . PHP_EOL;
echo "Stylesheet: biblio-ui@0.16.1" . PHP_EOL;
