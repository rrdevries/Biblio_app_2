...
final class ProductionLifecycleTest extends PersistenceIntegrationTestCase
{
    ...
    public function testActivationInstallsAndValidatesFreshBaseline(): void
    {
        ...
        try {
            ...
            self::assertTrue($this->state->isHealthCurrent(1020));
        } finally {
            $this->ensureBaseline();
        }
    }
    ...
    public function testProductionRegistryMatchesCurrentBaselineVersion(): void
    {
        ...
        self::assertSame(1020, CoreSchemaMigrator::CURRENT_VERSION);
        self::assertCount(20, $registry->migrations());
    ...
    {
        foreach (array_reverse($this->tableNames->schema1020()) as $table) {
    ...
    private function existingCoreTableCount(): int
    {
        ...
        foreach ($this->tableNames->schema1020() as $table) {
