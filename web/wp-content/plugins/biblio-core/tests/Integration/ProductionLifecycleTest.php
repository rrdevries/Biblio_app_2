...
final class ProductionLifecycleTest extends PersistenceIntegrationTestCase
{
    ...
    public function testActivationInstallsAndValidatesFreshBaseline(): void
    {
        ...
        try {
            ...
            self::assertSame(57, $this->existingCoreTableCount());
            self::assertSame(1026, $migrator->installedVersion());
            self::assertTrue(
                $migrator->health()->isHealthy(),
                $migrator->health()->summary()
            );
            self::assertTrue($this->state->isHealthCurrent(1026));
        } finally {
            $this->ensureBaseline();
        }
    }
    ...
    public function testProductionRegistryMatchesCurrentBaselineVersion(): void
    {
        ...
        self::assertSame(1026, CoreSchemaMigrator::CURRENT_VERSION);
        self::assertCount(26, $registry->migrations());
        ...
        self::assertSame(1013, $registry->migrations()[13]->sourceVersion());
        self::assertSame(1014, $registry->migrations()[13]->targetVersion());
        self::assertSame(1014, $registry->migrations()[14]->sourceVersion());
        self::assertSame(1015, $registry->migrations()[14]->targetVersion());
        self::assertSame(1015, $registry->migrations()[15]->sourceVersion());
        self::assertSame(1016, $registry->migrations()[15]->targetVersion());
        self::assertSame(1016, $registry->migrations()[16]->sourceVersion());
        self::assertSame(1017, $registry->migrations()[16]->targetVersion());
        self::assertSame(1017, $registry->migrations()[17]->sourceVersion());
        self::assertSame(1018, $registry->migrations()[17]->targetVersion());
        self::assertSame(1018, $registry->migrations()[18]->sourceVersion());
        self::assertSame(1019, $registry->migrations()[18]->targetVersion());
        self::assertSame(1019, $registry->migrations()[19]->sourceVersion());
        self::assertSame(1020, $registry->migrations()[19]->targetVersion());
        self::assertSame(1020, $registry->migrations()[20]->sourceVersion());
        self::assertSame(1021, $registry->migrations()[20]->targetVersion());
        self::assertSame(1021, $registry->migrations()[21]->sourceVersion());
        self::assertSame(1022, $registry->migrations()[21]->targetVersion());
        self::assertSame(1022, $registry->migrations()[22]->sourceVersion());
        self::assertSame(1023, $registry->migrations()[22]->targetVersion());
        self::assertSame(1023, $registry->migrations()[23]->sourceVersion());
        self::assertSame(1024, $registry->migrations()[23]->targetVersion());
        self::assertSame(1024, $registry->migrations()[24]->sourceVersion());
        self::assertSame(1025, $registry->migrations()[24]->targetVersion());
        self::assertSame(1025, $registry->migrations()[25]->sourceVersion());
        self::assertSame(1026, $registry->migrations()[25]->targetVersion());
    }
    ...
    public function testRuntimeRunsOnlyMissingSupportedMigration(): void
    {
        ...
        try {
            ...
            self::assertSame(1027, $this->migrator()->installedVersion());
            self::assertTrue($this->state->isHealthCurrent(1027));
        } finally {
            $migration->remove();
    ...
    private function ensureBaseline(): void
    {
        ...
        if ($this->existingCoreTableCount() !== 57) {
            $this->dropCoreSchema();
    ...
    {
        foreach (array_reverse($this->tableNames->schema1026()) as $table) {
    ...
    private function existingCoreTableCount(): int
    {
        ...
        foreach ($this->tableNames->schema1026() as $table) {
