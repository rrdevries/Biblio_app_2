...
final class ProductionLifecycleTest extends PersistenceIntegrationTestCase
{
    ...
    public function testActivationInstallsAndValidatesFreshBaseline(): void
    {
        ...
        try {
            ...
            self::assertTrue($this->state->isHealthCurrent(1019));
        } finally {
            $this->ensureBaseline();
        }
    }
    ...
    public function testProductionRegistryMatchesCurrentBaselineVersion(): void
    {
        ...
        self::assertSame(1019, CoreSchemaMigrator::CURRENT_VERSION);
        self::assertCount(19, $registry->migrations());
    ...
    {
        foreach (array_reverse($this->tableNames->schema1019()) as $table) {
    ...
    private function existingCoreTableCount(): int
    {
        ...
        foreach ($this->tableNames->schema1019() as $table) {
