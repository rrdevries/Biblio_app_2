...
final readonly class CoreSchemaMigrationRegistry
{
    ...
    private static function productionMigrations(
        ...
        return [
            ...
            new CoreSchema1004Migration($database, $tableNames),
            new CoreSchema1005Migration($database, $tableNames),
            new CoreSchema1006Migration($database, $tableNames),
            new CoreSchema1007Migration($database, $tableNames),
            new CoreSchema1008Migration($database, $tableNames),
            new CoreSchema1009Migration($database, $tableNames),
            new CoreSchema1010Migration($database, $tableNames),
            new CoreSchema1011Migration($database, $tableNames),
            new CoreSchema1012Migration($database, $tableNames),
            new CoreSchema1013Migration($database, $tableNames),
            new CoreSchema1014Migration($database, $tableNames),
            new CoreSchema1015Migration($database, $tableNames),
            new CoreSchema1016Migration($database, $tableNames),
            new CoreSchema1017Migration($database, $tableNames),
            new CoreSchema1018Migration($database, $tableNames),
            new CoreSchema1019Migration($database, $tableNames),
