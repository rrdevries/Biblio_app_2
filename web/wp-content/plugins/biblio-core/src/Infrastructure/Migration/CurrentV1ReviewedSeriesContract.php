...
/** Exact manifest-bound Series contract accepted in docs/132. */
final readonly class CurrentV1ReviewedSeriesContract
{
    public const VERSION = "d-mig-series-map-01.2026-09-17";
    ...
    public function __construct(private string $manifestSha256 = self::MANIFEST_SHA256)
    {
        if (preg_match('/^[a-f0-9]{64}$/D', $this->manifestSha256) !== 1) {
            throw new ValidationException("Series mapping manifest digest is invalid.");
        }
    }
