...
/** Exact manifest-bound Wishlist contract accepted in docs/134. */
final readonly class CurrentV1ReviewedWishlistContract
{
    public const VERSION = "d-mig-wishlist-map-01.2026-09-18";
    ...
    public function __construct(
        ...
        if (preg_match('/^[a-f0-9]{64}$/D', $this->manifestSha256) !== 1) {
            throw new ValidationException(
                "Wishlist mapping manifest digest is invalid."
            );
        }
    }
