...
/** Immutable binding to D-MIG-ITEMLOCAL-MAP-01 and its reviewed source. */
final readonly class CurrentV1ReviewedItemLocalContract
{
    public const VERSION = "d-mig-itemlocal-map-01.2026-09-16";
    ...
    public function __construct(
        ...
        if (preg_match('/^[a-f0-9]{64}$/', $this->manifestSha256) !== 1) {
            throw new ValidationException(
                "Reviewed Item-local manifest digest is invalid."
            );
        }
    }
