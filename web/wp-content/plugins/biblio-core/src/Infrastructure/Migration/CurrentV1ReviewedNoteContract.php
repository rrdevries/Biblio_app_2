...
/** Exact reviewed Note mapping contract from docs/126. */
final readonly class CurrentV1ReviewedNoteContract
{
    public const VERSION = "d-mig-note-map-01.2026-09-17";
    ...
    public function __construct(
        ...
        if (preg_match('/^[a-f0-9]{64}$/D', $this->manifestSha256) !== 1) {
            throw new ValidationException("Note mapping manifest digest is invalid.");
        }
    }
