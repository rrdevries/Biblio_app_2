...
/** Exact manifest-bound contained-work contract accepted in docs/139. */
final readonly class CurrentV1ReviewedContainedWorkContract
{
    public const VERSION = "d-mig-contained-map-01.2026-09-18";
    ...
    public function __construct(
        ...
        if (preg_match('/^[a-f0-9]{64}$/D', $this->manifestSha256) !== 1) {
            throw new ValidationException(
                "Contained-work mapping manifest digest is invalid."
            );
        }
    }
