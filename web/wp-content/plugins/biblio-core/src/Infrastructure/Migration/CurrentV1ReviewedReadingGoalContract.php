...
/** Exact manifest-bound Reading Goal preservation contract accepted by Renée. */
final readonly class CurrentV1ReviewedReadingGoalContract
{
    public const VERSION = "d-mig-reading-goal-map-01.2026-09-18";
    ...
    public function __construct(
        ...
        if (preg_match('/^[a-f0-9]{64}$/D', $this->manifestSha256) !== 1) {
            throw new ValidationException(
                "Reading Goal mapping manifest digest is invalid."
            );
        }
    }
