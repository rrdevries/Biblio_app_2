...
final class AuthorMigrationFailure extends RuntimeException implements
    MigrationParticipantFailure
{
    public function __construct(
        private readonly AuthorMigrationReason $reason,
        string $message,
    ...
    public function reason(): AuthorMigrationReason { return $this->reason; }
