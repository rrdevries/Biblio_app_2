...
final readonly class CoreApplication
{
    public function __construct(
        ...
        private AddBookCommitService $addBookCommit,
    ...
    {
        return $this->migrationReconciliation;
    }
    ...
    public function bibliographicAuthorWorkSearch(): BibliographicAuthorWorkSearchService
    {
        return $this->bibliographicAuthorWorkSearch;
    }

    public function bibliographicEditionSearch(): BibliographicEditionSearchService
    {
        return $this->bibliographicEditionSearch;
    }

    public function bibliographicMaterialization(): BibliographicMaterializationService
    {
        return $this->bibliographicMaterialization;
    }
    ...
    public function addBookCommit(): AddBookCommitService
    {
        return $this->addBookCommit;
    }
